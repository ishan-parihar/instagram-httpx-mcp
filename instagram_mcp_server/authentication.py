"""
Authentication logic for Instagram MCP Server.

Handles Instagram session management with persistent browser profile.
"""
...
def get_authentication_source() -> bool:
    ...
    if profile_exists(profile_dir) or cookies_path.exists():
        raise CredentialsNotFoundError(
            "Instagram source session metadata is missing or incomplete.\n\n"
    ...
    raise CredentialsNotFoundError(
        "No Instagram source session found.\n\n"
        "Options:\n"
        ...
        "  Then mount into Docker: -v ~/.instagram-mcp:/home/pwuser/.instagram-mcp"
    )
