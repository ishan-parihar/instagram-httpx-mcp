...
from instagram_mcp_server.core.exceptions import AuthenticationError, NetworkError
...
from instagram_mcp_server.scraping import InstagramExtractor
...
async def get_ready_extractor(
    ...
    *,
    ...
    try:
        ...
        return InstagramExtractor(browser.page)
